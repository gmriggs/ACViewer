...
namespace ACE.DatLoader.FileTypes
{
    ...
    {
        public SetupFlags Flags { get; set; }
        public bool AllowFreeHeading { get; set; }
        public bool HasPhysicsBSP { get; set; }
        ...
        public bool HasMissileFlightPlacement { get; set; } = false;
