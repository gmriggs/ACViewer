...
namespace ACE.DatLoader.FileTypes
{
    ...
    public class SpellTable : FileType
    {
        ...
        public PropertyDictionary<SpellId, SpellBase> Spells { get; } = new PropertyDictionary<SpellId, SpellBase>();

        /// <summary>
        /// the key uint refers to the SpellSetID, set in PropInt.EquipmentSetId
        /// </summary>
        public PropertyDictionary<EquipmentSet, SpellSet> SpellSet { get; } = new PropertyDictionary<EquipmentSet, SpellSet>();

        public override void Unpack(BinaryReader reader)
        {
            Id = reader.ReadUInt32();

            Spells._dict.UnpackPackedHashTable(reader);
            SpellSet._dict.UnpackPackedHashTable(reader);
        }
        ...
        {
            SpellBase spell = spellTable.Spells[(SpellId)spellId];
