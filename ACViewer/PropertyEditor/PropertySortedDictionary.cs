...
namespace ACViewer.PropertyEditor
{
    ...
    public class PropertySortedDictionary<T, U> : ICustomTypeDescriptor
    {
        public SortedDictionary<T, U> _dict;

        public PropertySortedDictionary()
        {
            _dict = new SortedDictionary<T, U>();
        }

        public PropertySortedDictionary(SortedDictionary<T, U> dict)
        {
            _dict = dict;
        }
        ...
        {
            private PropertySortedDictionary<T, U> dict = null;
            private T key;

            public PropertyDescriptor(PropertySortedDictionary<T, U> _dict, T _key) :
